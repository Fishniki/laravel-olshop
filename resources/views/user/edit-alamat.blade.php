...
<body>
    ...
    <div class="w-full max-w-2xl mx-auto">
        ...
        @endif
        <form class="space-y-6" action="{{ route('edit.alamat-save', $alamat->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div>
                ...
                <div class="mt-2">
                    <input type="text"
                        ...
                        name="nama" id="nama" value="{{ $alamat->nama }}" required>
                    @error('nama')
            ...
            <div>
                ...
                <div class="mt-2">
                    <input type="text"
                        ...
                        name="no_hp" id="no_hp" value="{{ $alamat->no_hp }}" required>
                    @error('no_hp')
                        <p class="invalid-feedback">{{ $message }}</p>
                    @enderror
                </div>
